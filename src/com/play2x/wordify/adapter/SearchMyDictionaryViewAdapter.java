...
public class SearchMyDictionaryViewAdapter extends BaseAdapter{
	...
	public SearchMyDictionaryViewAdapter(Activity a, ArrayList<DictionaryItem> d){
		activity = a;
		data = d;
						...
						case DELETE:
							...
							.setPositiveButton("Yes", new OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
									...
									BuildMyDictionary.removeByItem(item);
